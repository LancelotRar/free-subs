...
* **现 Star 数：** ![](https://img.shields.io/github/stars/cmliu/edgetunnel?style=flat-square&label=)
...
* **现 Star 数：** ![](https://img.shields.io/github/stars/byJoey/cfnew?style=flat-square&label=)
...
* **现 Star 数：** ![](https://img.shields.io/github/stars/eooce/Cloudflare-proxy?style=flat-square&label=)
* **作者博客：** 无
...
* **现 Star 数：** ![](https://img.shields.io/github/stars/yonggekkk/Cloudflare-vless-trojan?style=flat-square&label=)
...
## 🚀 本项目亮点
  ...
  -  **主流支持：** 深度适配 Clash、v2ray、Sing-box 等主流代理客户端。
  -  **CF 赋能：** 基于 Cloudflare 高性能开源方案搭建，兼顾速度与稳定性。
...
>### 4. 针对特定域名的精细化调优
>
>针对 `jsdelivr.net`等公共前端库或特定解析服务进行了单>独的直连优化。避免了因代理节点绕路导致的网页加载“卡图”、“卡脚本”问题，>网页秒开体验更佳。
>
>
