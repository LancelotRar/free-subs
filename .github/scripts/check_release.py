...
try:
    with open(DATA_FILE) as f:
        ...
        if lines:
            last_updated = lines[-1]  # take last non-empty line (handles old single-line ID format too)
except Exception:
    pass
...
print(f"Telegram notification sent and updated_at persisted: {latest_updated[:19]}")
