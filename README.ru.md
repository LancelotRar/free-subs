# 🏪 Общедоступная подписка Liqun
## Данный проект на основе технологии граничных вычислений Cloudflare предоставляет стабильные, высокоскоростные и постоянно бесплатные услуги подписки на прокси
...
## Обзор проектов для свободного доступа в интернет на Cloudflare (CF), пожалуйста, поставьте свой **Star** этим отличным проектам с открытым исходным кодом!
...
<p align="center">
  <img src="src/PC1.png" alt="Скриншот" width="430" height="240">
</p>

## 📥 Примечания к подписке
...
* [**Личный шаблон конфигурации Mihomo**](/src/liqun_example.yaml) — постоянно оптимизируются лучшие практики. Можно сделать fork и изменять самостоятельно или использовать напрямую.
* Поскольку узлы CF имеют **ограниченный срок действия**, в этом общественном проекте рекомендуется использовать **клиент Mihomo**. Он позволяет **автоматически обновлять подписку по расписанию, автоматически проверять задержку и автоматически выбирать узел с наименьшей задержкой**, обеспечивая прокси в один клик без лишних настроек. Установка интервала автообновления подписки на 3 часа — оптимальный вариант. Лично рекомендую лёгкий и удобный [**Bettbox**](https://github.com/appshubcc/Bettbox), [**чат-группа Bettbox**](https://t.me/appshub_chat). Если вы раньше были пользователем FlClash, вы быстро освоитесь.
* При обнаружении злоупотреблений или краулеров, приводящих к аномальному отказу узлов, доступ будет **отключён в любой момент**.
