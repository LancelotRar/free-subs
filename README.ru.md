...
<a href="https://www.star-history.com/#LancelotRar/free-subs&Date">
 <picture>
   ...
   <img alt="График Star History" src="https://api.star-history.com/chart?repos=LancelotRar/free-subs&type=date&legend=top-left" />
 </picture>
</a>

## ⚖️ Отказ от ответственности

1. Все ресурсы взяты из открытых источников интернета, предназначены только для обмена техническими исследованиями.
2. Соблюдайте местные законы, не используйте в незаконных целях.
3. Как общественный проект, не гарантирует абсолютную стабильность и доступность, не используйте в важных производственных средах.
